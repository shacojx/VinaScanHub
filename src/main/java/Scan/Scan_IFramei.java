 ...
 * @author laxba
 */
public class Scan_IFramei {

    public void scanIFramein(Element element, String urlAction, String[] payload) throws IOException {
        String vulnName = "IFrame Injection";
        ...
        for (String sPay : payload) {
            ...
            for (String lPay : listPay) {
                ...
                try {
                        ...
                        try {
                            ...
                            for (String s : lURL.split("&")) {
                                ...
                                try {
                                    ...
                                    System.out.println("Error Value attackVulnIFramei: " + e);
                                }
                    ...
                    System.out.println("Error attackVulnIFramei: " + urlAction + " ||| " + e);
                }
            }
            if (checkVuln) {
                break;
